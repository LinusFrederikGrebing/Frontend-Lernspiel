<template>
  ...
  <div>
    <v-card elevation="24" height="55em" outlined shaped class="container">
      <h1 class="section_header font-weight-black"> - {{ $t("navigation.helpHeader") }} - </h1>
      <v-btn
        class="back-btn"
        depressed
        elevation="2"
                    ...
                    <v-card class="mx-auto my-10 card" elevation="20">
                      <div class="container-image-chapter-open">
                        <div class="image">
                          ...
                          <h2 class="h2pop white--text text-h4 text-md-h3"><i>{{ item.label }}!</i></h2>
                        </div>
                      </div>
                      <v-card-title>
                        {{ item.title }}
                      ...
                      <div class="d-md-flex">
                        <v-img :src="item.example" class="ml-4 mr-8" max-height="100px" contain></v-img>
