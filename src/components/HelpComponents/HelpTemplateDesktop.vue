  ...
  <div>
    <v-card elevation="24" height="55em" outlined shaped class="container">
      ...
      <v-btn
        ...
        <svg style="color: white" xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-x" viewBox="0 0 16 16"> <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z" fill="white"></path> </svg>
      </v-btn>
      <v-container>
    ...
    return {
      informations: [
        ...
        },
        {
          ...
          Beispiel: require('../../assets/functionExample.jpg'),
          beispieltext: 'Anhand der in die Funktion übergebene Parameter kann das Element ermittelt und dem jeweiligen Element die Klasse "painted" zugewiesen werden. Der Funktionsaufruf geschieht über den Namen der Funktion und passender Parameterübergabe.',
        ...
        },
        {
          ...
          Beispiel: require('../../assets/forExample.jpg'),
        ...
        },
        {
          ...
          Beispiel: require('../../assets/whileExample.jpg'),
        ...
        },
        {
          ...
          Beispiel: require('../../assets/dowhileExample.jpg'),
